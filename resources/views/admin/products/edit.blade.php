        ...
        <div class="col-md-9">
            <div class="row mt-2">
                <div class="col-md-12">
                    ...
                    <h3 class="mt-2">Edit a Product</h3>
                    <hr>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <form action="{{ route('admin.products.update',$product->slug) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->thumbnail)}}" id="thumbnail-preview"
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->first_image)}}" id="first_image-preview"
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->second_image)}}" id="second_image-preview"
                                ...
                                <div class="mt-2">
                                    <img src="{{asset($product->third_image)}}" id="third_image-preview"
